...
class RKM(RBM):
    ...
    Also, refer to the paper https://arxiv.org/abs/2509.15842 (also published in PNAS https://www.pnas.org/doi/abs/10.1073/pnas.2525792123) for more details on the RKM.
