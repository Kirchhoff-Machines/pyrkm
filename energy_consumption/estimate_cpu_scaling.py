...
# Read the CSV file
df = pd.read_csv('./cpu_energy_power_analysis.csv')
...
plt.tight_layout()
plt.savefig('cpu_energy_power_analysis_extrapolation.png')
plt.show()
...
estimated_df.to_csv('cpu_estimated_points.csv', index=False)
